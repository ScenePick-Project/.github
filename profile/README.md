...
| 구분 | 기술 |
| :--- | :--- |
| **Frontend** | React, TypeScript, Vite, React Router, React Hook Form, Yup, Tailwind CSS |
| **Backend** | Java, Spring Boot, Spring Security, OAuth2, JWT, MyBatis |
| **Database** | Oracle Autonomous Database |
| **Infrastructure** | Cloudflare, AWS S3, OCI, Kubernetes, ingress-nginx |
| **Collaboration** | GitHub, Figma, Swagger, Google Sheets |
...
회원, 작품, 에피소드, 장면, 리뷰, OST 등  
ScenePick의 주요 도메인 관계를 설계한 ERD입니다.

<img width="1999" height="1126" alt="image" src="https://github.com/user-attachments/assets/fc372ec0-c37e-418c-b0c7-8ba5aaed6cef" />
